...
public final class ADifExpressaoSimples extends PExpressaoSimples
{
    private PExpressaoSimples _exp1_;
    private PExpressaoSimples _exp2_;

    public ADifExpressaoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADifExpressaoSimples(
    ...
    {
        ((Analysis) sw).caseADifExpressaoSimples(this);
    }

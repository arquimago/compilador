...
public final class ASubtrativaExpressaoSimples extends PExpressaoSimples
{
    private PExpressaoSimples _exp1_;
    private PExpressaoSimples _exp2_;

    public ASubtrativaExpressaoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASubtrativaExpressaoSimples(
    ...
    {
        ((Analysis) sw).caseASubtrativaExpressaoSimples(this);
    }

...
public final class AMatrizNulaVariavel extends PVariavel
{
    ...
    public Object clone()
    {
        return new AMatrizNulaVariavel(
    ...
    {
        ((Analysis) sw).caseAMatrizNulaVariavel(this);
    }

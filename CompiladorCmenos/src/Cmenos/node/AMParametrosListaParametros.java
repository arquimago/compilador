...
public final class AMParametrosListaParametros extends PListaParametros
{
    private PListaParametros _listaParametros_;
    private TVirgula _virgula_;
    private PParametro _parametro_;

    public AMParametrosListaParametros()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMParametrosListaParametros(
    ...
    {
        ((Analysis) sw).caseAMParametrosListaParametros(this);
    }

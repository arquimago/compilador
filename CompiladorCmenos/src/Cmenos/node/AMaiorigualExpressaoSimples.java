...
public final class AMaiorigualExpressaoSimples extends PExpressaoSimples
{
    private PExpressaoSimples _exp1_;
    private PExpressaoSimples _exp2_;

    public AMaiorigualExpressaoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorigualExpressaoSimples(
    ...
    {
        ((Analysis) sw).caseAMaiorigualExpressaoSimples(this);
    }

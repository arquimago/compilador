...
public final class AMultiplicativaExpressaoSimples extends PExpressaoSimples
{
    private PExpressaoSimples _exp1_;
    private PExpressaoSimples _exp2_;

    public AMultiplicativaExpressaoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultiplicativaExpressaoSimples(
    ...
    {
        ((Analysis) sw).caseAMultiplicativaExpressaoSimples(this);
    }

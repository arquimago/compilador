...
public final class AMenorExpressaoSimples extends PExpressaoSimples
{
    private PExpressaoSimples _exp1_;
    private PExpressaoSimples _exp2_;

    public AMenorExpressaoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorExpressaoSimples(
    ...
    {
        ((Analysis) sw).caseAMenorExpressaoSimples(this);
    }

...
public final class AMenorigualExpressaoSimples extends PExpressaoSimples
{
    private PExpressaoSimples _exp1_;
    private PExpressaoSimples _exp2_;

    public AMenorigualExpressaoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorigualExpressaoSimples(
    ...
    {
        ((Analysis) sw).caseAMenorigualExpressaoSimples(this);
    }

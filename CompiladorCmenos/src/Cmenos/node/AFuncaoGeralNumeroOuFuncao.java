...
public final class AFuncaoGeralNumeroOuFuncao extends PNumeroOuFuncao
{
    private PChamaFuncao _chamaFuncao_;

    public AFuncaoGeralNumeroOuFuncao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFuncaoGeralNumeroOuFuncao(
    ...
    {
        ((Analysis) sw).caseAFuncaoGeralNumeroOuFuncao(this);
    }

...
public final class ADivisaoExpressaoSimples extends PExpressaoSimples
{
    private PExpressaoSimples _exp1_;
    private PExpressaoSimples _exp2_;

    public ADivisaoExpressaoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADivisaoExpressaoSimples(
    ...
    {
        ((Analysis) sw).caseADivisaoExpressaoSimples(this);
    }

...
public final class AFuncaoSParamSDeclaracao extends PSDeclaracao
{
    private TId _id_;
    ...
    public AFuncaoSParamSDeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFuncaoSParamSDeclaracao(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAFuncaoSParamSDeclaracao(this);
    }

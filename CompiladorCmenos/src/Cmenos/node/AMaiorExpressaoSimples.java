...
public final class AMaiorExpressaoSimples extends PExpressaoSimples
{
    private PExpressaoSimples _exp1_;
    private PExpressaoSimples _exp2_;

    public AMaiorExpressaoSimples()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorExpressaoSimples(
    ...
    {
        ((Analysis) sw).caseAMaiorExpressaoSimples(this);
    }
